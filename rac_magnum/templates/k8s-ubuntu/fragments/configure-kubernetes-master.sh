...
docker pull ${_prefix}kubernetes-apiserver:${KUBE_TAG}
docker pull ${_prefix}kubernetes-controller-manager:${KUBE_TAG}
docker pull ${_prefix}kubernetes-scheduler:${KUBE_TAG}
